 ...
 */
require(dirname(__FILE__) . DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'lib' . DIRECTORY_SEPARATOR . 'class.phpmailer.php');
...
class Mailer extends PHPMailer {
    ...
    const CONFIG_PARAMS = 'mailer'; //Define the key of the Yii params for the config array
